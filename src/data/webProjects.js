export const webProjects = [
  ...
  },
  {
    ...
    contributions: {
      fr: [
        ...
        "Participation aux ateliers métier (PO/utilisateurs) pour formaliser les règles et réduire les retours QA.",
      ],
      en: [
        ...
        "Participated in business workshops (PO/users) to formalize rules and reduce QA feedback.",
      ],
    },
  },
  {
    ...
    contributions: {
      fr: [
        ...
        "Connexion et synchronisation avec l'API Symfony existante (Lot 1 – système de cartels) : consommation REST, gestion des erreurs, compatibilité avec le schéma de données établi.",
      ...
      en: [
        ...
        "Connection and synchronization with the existing Symfony API (Lot 1 – cartel system): REST consumption, error handling, compatibility with the established data schema.",
  ...
  },
  {
    ...
    contributions: {
      fr: [
        ...
        "Intégration des endpoints API NestJS (CRUD + métier) et gestion des erreurs/droits côté front.",
      ...
      en: [
        ...
        "Integrated NestJS API endpoints (CRUD + business) and error/rights management on the front-end.",
  ...
  },
  {
    ...
    context: {
      fr: "Projet académique pour visualiser des données de cryptomonnaies.",
      en: "Academic project to visualise cryptocurrency data.",
    },
    role: {
      fr: "Développeuse Data / Front",
      en: "Data / Front-end Developer",
    },
    description: {
    ...
    technologies: "Python / JS, data visualisation (charts)",
    githubUrl: null,
  },
  {
    id: "pictsmanager",
    ...
    technologies: "Mobile (React Native ou équivalent), stockage local",
